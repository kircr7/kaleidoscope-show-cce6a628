...
(_a = globalThis.__VITE_REACT_SSG_TRACK_SSR_MODULE__) == null ? void 0 : _a.call(globalThis, "src/pages/BlogPost.tsx");
const BlogPost = () => {
  ...
  if (!article && !legacyPost) return /* @__PURE__ */ jsxDEV(Navigate, { to: "/blog", replace: true }, void 0, false, {
  ...
  const renderLegacyContent = (content) => {
    return content.split("\n").map((line, i) => {
      ...
      if (!trimmed) return /* @__PURE__ */ jsxDEV("br", {}, i, false, {
        fileName: "/dev-server/src/pages/BlogPost.tsx",
        lineNumber: 27,
        columnNumber: 28
      }, void 0);
      if (trimmed.startsWith("### ")) {
        return /* @__PURE__ */ jsxDEV("h3", { className: "text-lg sm:text-xl font-bold text-[hsl(var(--foreground))] mt-8 mb-3", children: trimmed.slice(4) }, i, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 30,
          columnNumber: 11
        }, void 0);
      ...
      if (trimmed.startsWith("## ")) {
        return /* @__PURE__ */ jsxDEV("h2", { className: "text-xl sm:text-2xl font-bold text-[hsl(var(--foreground))] mt-10 mb-4", children: trimmed.slice(3) }, i, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 37,
          columnNumber: 11
        }, void 0);
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "min-h-screen bg-black overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxDEV("main", { className: "pt-24 sm:pt-32 pb-16 sm:pb-24 px-4", children: /* @__PURE__ */ jsxDEV("article", { className: "container max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxDEV(
        Link,
        {
          to: "/blog",
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxDEV("span", { className: "px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[hsl(45,90%,55%)/0.15] text-[hsl(45,90%,55%)] border border-[hsl(45,90%,55%)/0.2]", children: category }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogPost.tsx",
            lineNumber: 134,
            columnNumber: 15
          }, void 0),
          /* @__PURE__ */ jsxDEV("span", { className: "flex items-center gap-1 text-sm text-[hsl(var(--muted-foreground))]", children: [
        ...
        /* @__PURE__ */ jsxDEV("h1", { className: "text-2xl sm:text-3xl md:text-4xl font-bold text-[hsl(var(--foreground))] leading-tight", children: h1 }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 146,
          columnNumber: 13
        }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "rounded-2xl overflow-hidden border border-[hsl(var(--border))] mb-10", children: /* @__PURE__ */ jsxDEV(
        "img",
        {
          src: image,
          alt: h1,
      ...
      article ? /* @__PURE__ */ jsxDEV(
        ...
        void 0
      ) : /* @__PURE__ */ jsxDEV("div", { className: "prose-custom", children: renderLegacyContent(legacyPost.content) }, void 0, false, {
        fileName: "/dev-server/src/pages/BlogPost.tsx",
        lineNumber: 166,
        columnNumber: 13
      }, void 0),
      /* @__PURE__ */ jsxDEV("div", { className: "mt-16 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(0,0%,6%)] p-6 sm:p-10 text-center", children: [
        /* @__PURE__ */ jsxDEV(Printer, { className: "w-10 h-10 text-[hsl(45,90%,55%)] mx-auto mb-4" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 173,
          columnNumber: 13
        }, void 0),
        /* @__PURE__ */ jsxDEV("h3", { className: "text-xl sm:text-2xl font-bold text-[hsl(var(--foreground))] mb-3", children: "Нужна печать чертежей?" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 174,
          columnNumber: 13
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-[hsl(var(--muted-foreground))] mb-6 max-w-md mx-auto", children: "Распечатаем строго по ГОСТу. Быстрый расчет стоимости онлайн." }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogPost.tsx",
          lineNumber: 177,
          columnNumber: 13
        }, void 0),
