...
(_a = globalThis.__VITE_REACT_SSG_TRACK_SSR_MODULE__) == null ? void 0 : _a.call(globalThis, "src/components/Navbar.tsx");
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, { children: [
    /* @__PURE__ */ jsxDEV(
      "nav",
      {
        ...
        children: [
          /* @__PURE__ */ jsxDEV(Link, { to: "/", "aria-label": "ПринтПРО — на главную", className: "px-2 py-1 rounded-full flex items-center flex-shrink-0", children: /* @__PURE__ */ jsxDEV("img", { src: logoImg, alt: "ПринтПРО — печать чертежей", className: "h-5 lg:h-6 brightness-0 invert opacity-70 hover:opacity-100 transition-opacity" }, void 0, false, {
          ...
          /* @__PURE__ */ jsxDEV(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxDEV("span", { className: "absolute inset-0 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-pink-500 blur-md opacity-0 cta-glow" }, void 0, false, {
                  fileName: "/dev-server/src/components/Navbar.tsx",
                  lineNumber: 78,
                  columnNumber: 11
                }, void 0),
                /* @__PURE__ */ jsxDEV("span", { className: "relative block px-4 lg:px-6 py-2.5 rounded-full text-sm font-bold text-white whitespace-nowrap", style: { background: "hsl(0, 0%, 8%)" }, children: "Сделать заказ" }, void 0, false, {
                  fileName: "/dev-server/src/components/Navbar.tsx",
                  lineNumber: 79,
                  columnNumber: 11
                }, void 0)
      ...
      "nav",
      {
        ...
        children: /* @__PURE__ */ jsxDEV(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxDEV(Link, { to: "/", "aria-label": "ПринтПРО — на главную", className: "px-1 py-0.5 flex items-center", children: /* @__PURE__ */ jsxDEV("img", { src: logoImg, alt: "ПринтПРО", className: "h-5 brightness-0 invert opacity-70" }, void 0, false, {
                fileName: "/dev-server/src/components/Navbar.tsx",
                lineNumber: 98,
                columnNumber: 13
              }, void 0) }, void 0, false, {
              ...
              /* @__PURE__ */ jsxDEV("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxDEV("a", { href: "/#calculator", onClick: (e) => handleNavClick(e, "/#calculator"), className: "relative group cta-glow-wrap", children: [
                  /* @__PURE__ */ jsxDEV("span", { className: "absolute inset-0 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-pink-500 opacity-60 group-hover:opacity-100 transition-opacity duration-500" }, void 0, false, {
                    fileName: "/dev-server/src/components/Navbar.tsx",
                    lineNumber: 103,
                    columnNumber: 15
                  }, void 0),
                  ...
                  /* @__PURE__ */ jsxDEV("span", { className: "relative block px-4 py-2 rounded-full text-[11px] font-bold text-white bg-[hsl(0,0%,8%)] m-[1.5px]", children: "Сделать заказ" }, void 0, false, {
                    fileName: "/dev-server/src/components/Navbar.tsx",
                    lineNumber: 105,
                    columnNumber: 15
                  }, void 0)
                ...
                /* @__PURE__ */ jsxDEV(
                  "button",
                  {
                    ...
                    children: isMobileMenuOpen ? /* @__PURE__ */ jsxDEV(X, { className: "w-5 h-5" }, void 0, false, {
                      fileName: "/dev-server/src/components/Navbar.tsx",
                      lineNumber: 114,
                      columnNumber: 35
                    }, void 0) : /* @__PURE__ */ jsxDEV(Menu, { className: "w-5 h-5" }, void 0, false, {
                      fileName: "/dev-server/src/components/Navbar.tsx",
                      lineNumber: 114,
                      columnNumber: 63
                    }, void 0)
    ...
    /* @__PURE__ */ jsxDEV("div", { className: `md:hidden fixed inset-0 z-40 bg-black/95 backdrop-blur-xl transition-all duration-500 ${isMobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`, children: /* @__PURE__ */ jsxDEV("div", { className: "flex flex-col items-center justify-center h-full gap-8", children: [
      navLinks.map((link) => /* @__PURE__ */ jsxDEV(
        "a",
        {
          href: link.href,
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "w-12 h-px bg-white/10" }, void 0, false, {
        fileName: "/dev-server/src/components/Navbar.tsx",
        lineNumber: 133,
        columnNumber: 11
      }, void 0),
      /* @__PURE__ */ jsxDEV("a", { href: "tel:+79851547772", className: "text-sm text-white/30 font-medium", children: "+7 (985) 154-77-72" }, void 0, false, {
        fileName: "/dev-server/src/components/Navbar.tsx",
        lineNumber: 134,
        columnNumber: 11
      }, void 0)
...
(_b = globalThis.__VITE_REACT_SSG_TRACK_SSR_MODULE__) == null ? void 0 : _b.call(globalThis, "src/components/Footer.tsx");
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxDEV("footer", { id: "footer", className: "relative bg-[hsl(0,0%,4%)] text-[hsl(var(--foreground))] overflow-hidden", children: [
    /* @__PURE__ */ jsxDEV(
      "div",
      {
    ...
    /* @__PURE__ */ jsxDEV("div", { className: "relative z-10 container max-w-6xl mx-auto px-4 pt-16 pb-8", children: [
      /* @__PURE__ */ jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "md:col-span-4 space-y-5", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "group flex items-center gap-3 cursor-default", children: /* @__PURE__ */ jsxDEV("img", { src: logoImg, alt: "ПринтПРО — типография инженерной печати", className: "h-7 brightness-0 invert opacity-80" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 51,
            columnNumber: 15
          }, void 0) }, void 0, false, {
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-sm leading-relaxed text-[hsl(var(--muted-foreground))]", children: "Центр инженерной печати. Профессиональная работа с технической документацией любого объема и сложности." }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 54,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("div", { children: [
            /* @__PURE__ */ jsxDEV("p", { className: "text-xs font-semibold uppercase tracking-widest text-[hsl(var(--muted-foreground))] mb-3", children: "Специализация:" }, void 0, false, {
              fileName: "/dev-server/src/components/Footer.tsx",
              lineNumber: 59,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("ul", { className: "space-y-2", children: specs.map((spec) => /* @__PURE__ */ jsxDEV("li", { className: "flex items-center gap-2 text-sm text-[hsl(var(--muted-foreground))]", children: [
              /* @__PURE__ */ jsxDEV(FileText, { size: 14, className: "text-[hsl(45,90%,55%)] flex-shrink-0" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 65,
                columnNumber: 21
              }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "md:col-span-3 space-y-5", children: [
          /* @__PURE__ */ jsxDEV("h4", { className: "text-base font-semibold text-[hsl(var(--foreground))]", children: "Наши контакты" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 75,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxDEV("div", { className: "flex items-start gap-3 text-sm text-white", children: [
              /* @__PURE__ */ jsxDEV(MapPin, { size: 16, className: "text-[hsl(45,90%,55%)] mt-0.5 flex-shrink-0" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 78,
                columnNumber: 17
              }, void 0),
            ...
            /* @__PURE__ */ jsxDEV("div", { className: "flex items-center gap-3 text-sm", children: [
              /* @__PURE__ */ jsxDEV(Phone, { size: 16, className: "text-[hsl(45,90%,55%)] flex-shrink-0" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 82,
                columnNumber: 17
              }, void 0),
              /* @__PURE__ */ jsxDEV("a", { href: "tel:+79851547772", className: "text-white hover:text-white/80 transition-colors", children: "+7 (985) 154-77-72" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 83,
                columnNumber: 17
              }, void 0)
            ...
            /* @__PURE__ */ jsxDEV("div", { className: "flex items-center gap-3 text-sm", children: [
              /* @__PURE__ */ jsxDEV(Mail, { size: 16, className: "text-[hsl(45,90%,55%)] flex-shrink-0" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 88,
                columnNumber: 17
              }, void 0),
              /* @__PURE__ */ jsxDEV("a", { href: "mailto:printprro@gmail.com", className: "text-white hover:text-white/80 transition-colors", children: "printprro@gmail.com" }, void 0, false, {
                fileName: "/dev-server/src/components/Footer.tsx",
                lineNumber: 89,
                columnNumber: 17
              }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "md:col-span-5 space-y-5", children: [
          /* @__PURE__ */ jsxDEV("h4", { className: "text-base font-semibold text-[hsl(var(--foreground))]", children: "Мы на карте" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 98,
            columnNumber: 13
          }, void 0),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxDEV(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxDEV("div", { className: "relative bg-[hsl(var(--card))] p-3", children: [
                      /* @__PURE__ */ jsxDEV("p", { className: "text-xs font-semibold text-[hsl(var(--foreground))] mb-2", children: "ПринтПро" }, void 0, false, {
                        fileName: "/dev-server/src/components/Footer.tsx",
                        lineNumber: 114,
                        columnNumber: 19
                      }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "mt-10 sm:mt-12 pt-6 border-t border-[hsl(var(--border))] flex flex-col md:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-xs text-[hsl(var(--muted-foreground))] text-center md:text-left space-y-1", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { children: "ИНН: 245907557883 · ОГРНИП: 326246800000141" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 151,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "flex flex-col sm:flex-row gap-3 sm:gap-6 text-center", children: [
          /* @__PURE__ */ jsxDEV("a", { href: "/blog", className: "text-xs text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors", children: "Блог" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 154,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("a", { href: "/privacy", className: "text-xs text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors", children: "Политика конфиденциальности" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 157,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("a", { href: "/terms", className: "text-xs text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors", children: "Условия обслуживания" }, void 0, false, {
            fileName: "/dev-server/src/components/Footer.tsx",
            lineNumber: 160,
            columnNumber: 13
          }, void 0)
