...
const routes = [
  {
    ...
    children: [
      {
        index: true,
        lazy: () => import("./assets/Index-2Ls1FDE9.js").then((m) => ({ Component: m.default }))
      },
      {
        path: "blog",
        lazy: () => import("./assets/Blog-BA8ZfJZb.js").then((m) => ({ Component: m.default }))
      },
      {
        path: "blog/:slug",
        lazy: () => import("./assets/BlogPost-WD4dMoWO.js").then((m) => ({ Component: m.default })),
        getStaticPaths: () => [
      ...
      {
        path: "privacy",
        lazy: () => import("./assets/PrivacyPolicy-DAkoiQCG.js").then((m) => ({ Component: m.default }))
      },
      {
        path: "terms",
        lazy: () => import("./assets/TermsOfService-Kar3NWaC.js").then((m) => ({ Component: m.default }))
      },
      {
        path: "*",
        lazy: () => import("./assets/NotFound-BPFIlqIu.js").then((m) => ({ Component: m.default }))
      }
    ]
  }
];
