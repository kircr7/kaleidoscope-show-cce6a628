  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "nav",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Link, { to: "/", "aria-label": "ПринтПРО — на главную", className: "px-2 py-1 rounded-full flex items-center flex-shrink-0", children: /* @__PURE__ */ jsx("img", { src: logoImg, alt: "ПринтПРО — печать чертежей", className: "h-5 lg:h-6 brightness-0 invert opacity-70 hover:opacity-100 transition-opacity" }) }),
          ...
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "relative block px-4 lg:px-6 py-2.5 rounded-full text-sm font-bold text-white whitespace-nowrap", style: { background: "hsl(0, 0%, 8%)" }, children: "Сделать заказ" })
              ]
            }
          )
        ]
      ...
      "nav",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Link, { to: "/", "aria-label": "ПринтПРО — на главную", className: "px-1 py-0.5 flex items-center", children: /* @__PURE__ */ jsx("img", { src: logoImg, alt: "ПринтПРО", className: "h-5 brightness-0 invert opacity-70" }) }),
