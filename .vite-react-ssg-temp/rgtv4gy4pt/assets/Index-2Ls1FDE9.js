...
const OrderSection = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { id: "calculator", className: "relative py-12 sm:py-20 md:py-32 px-3 sm:px-4 bg-white overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "relative z-10 container max-w-7xl mx-auto overflow-hidden", children: /* @__PURE__ */ jsxs(
      "div",
      {
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsx("span", { className: "text-[11px] sm:text-xs font-medium leading-relaxed", style: { color: "hsl(45,100%,80%)" }, children: "Извините, в связи с высокой загруженностью минимальный заказ — 500 ₽." })
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "relative z-10 mt-8", children: [
                    ...
                    fileStatus === "success" ? /* @__PURE__ */ jsxs("div", { className: "text-center py-6", children: [
                      ...
                      fileLink && /* @__PURE__ */ jsxs(Fragment, { children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                          /* @__PURE__ */ jsx(Mail, { className: "absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4", style: { color: "hsl(0,0%,50%)" } }),
                          /* @__PURE__ */ jsx(
                            "input",
                            {
                              required: true,
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-white", children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-5", style: { borderBottom: "1px solid hsl(240,9%,17%)" }, children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-[1.4fr_1fr] gap-3 mb-3", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "flex p-1 rounded-lg gap-1", style: { backgroundColor: "hsla(240,15%,15%,0.6)", border: "1px solid hsl(240,9%,17%)" }, children: [
                          /* @__PURE__ */ jsx(
                            "button",
                            {
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex gap-2 sm:gap-3 mb-4", children: [
                      /* @__PURE__ */ jsxs(
                        "div",
                        {
                          ...
                          style: { backgroundColor: "hsla(240,15%,15%,0.8)", border: "1px solid hsl(240,9%,17%)" },
                          children: [
                            /* @__PURE__ */ jsx("button", { onClick: () => setQuantity(Math.max(1, quantity - 1)), className: "text-xl font-light p-2 transition-all duration-150 text-[hsl(0,0%,60%)] hover:text-[hsl(0,100%,62%)] hover:[text-shadow:0_0_6px_hsl(0_100%_55%/0.9)] active:text-[hsl(0,100%,55%)]", children: "−" }),
                            /* @__PURE__ */ jsx(
                              "input",
                              {
                                type: "number",
                            ...
                            /* @__PURE__ */ jsx("button", { onClick: () => setQuantity(quantity + 1), className: "text-xl font-light p-2 transition-all duration-150 text-[hsl(0,0%,60%)] hover:text-[hsl(140,100%,55%)] hover:[text-shadow:0_0_6px_hsl(140_100%_50%/0.9)] active:text-[hsl(140,100%,48%)]", children: "+" })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsx(
                      ...
                      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-1.5 sm:gap-2", children: SERVICES.map((service) => /* @__PURE__ */ jsxs(
                        "button",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4 flex-shrink-0 transition-all duration-150 text-[hsl(266,92%,68%)] group-hover/add:text-[hsl(140,100%,55%)] group-hover/add:[filter:drop-shadow(0_0_3px_hsl(140_100%_50%/0.9))] group-active/add:text-[hsl(140,100%,48%)]" })
                          ]
                        },
                        service.id
                      )) })
                  ...
                  /* @__PURE__ */ jsx("div", { className: "p-4 sm:p-6", children: status !== "success" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      ...
                      cart.map((item) => {
                        ...
                        return /* @__PURE__ */ jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-white leading-tight", children: item.label }),
                              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2 mt-1.5 flex-wrap", children: [
                                /* @__PURE__ */ jsx("div", { className: "text-[10px] font-medium flex items-center gap-1.5 flex-wrap min-w-0", style: { color: "hsl(0,0%,50%)" }, children: (() => {
                                ...
                                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 sm:gap-2 flex-shrink-0 ml-auto", children: [
                                  /* @__PURE__ */ jsxs("div", { className: "flex items-center rounded-lg", style: { border: "1px solid hsl(240,9%,17%)" }, children: [
                                    /* @__PURE__ */ jsx(
                                      "button",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsx(Minus, { className: "w-3 h-3 transition-all duration-150 text-[hsl(0,0%,60%)] group-hover/minus:text-[hsl(0,100%,62%)] group-hover/minus:[filter:drop-shadow(0_0_3px_hsl(0_100%_55%/0.9))] group-active/minus:text-[hsl(0,100%,55%)]" })
                                      }
                                    ),
                                    /* @__PURE__ */ jsx(
                                      "input",
                                    ...
                                    /* @__PURE__ */ jsx(
                                      "button",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsx(Plus, { className: "w-3 h-3 transition-all duration-150 text-[hsl(0,0%,60%)] group-hover/plus:text-[hsl(140,100%,55%)] group-hover/plus:[filter:drop-shadow(0_0_3px_hsl(140_100%_50%/0.9))] group-active/plus:text-[hsl(140,100%,48%)]" })
                                      }
                                    )
                                  ] }),
                                  /* @__PURE__ */ jsxs("span", { className: "text-xs sm:text-sm font-bold text-white min-w-[2.5rem] text-right", children: [
                                    lineTotal,
                                    " ₽"
                                  ] }),
                                  /* @__PURE__ */ jsx("button", { onClick: () => removeItem(item.id), className: "p-1 sm:p-1.5 hover:bg-red-500/10 rounded-full transition-colors", children: /* @__PURE__ */ jsx(Trash2, { className: "w-3 h-3 sm:w-3.5 sm:h-3.5 text-red-400/70" }) })
                                ] })
                              ] }),
                              !item.isService && itemRemaining > 0 && /* @__PURE__ */ jsxs("div", { className: "text-[10px] mt-1.5 font-semibold", style: { color: "hsl(266,92%,78%)" }, children: [
                                "Добавьте ",
                                itemRemaining,
                                " шт. для оптовой цены"
                              ] })
                    ...
                    cart.length > 0 && /* @__PURE__ */ jsxs("form", { ref: orderFormRef, onSubmit: sendOrder, encType: "multipart/form-data", className: "space-y-3 pt-4", style: { borderTop: "1px solid hsl(240,9%,17%)" }, children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        /* @__PURE__ */ jsx(Mail, { className: "absolute left-4 top-4 w-4 h-4", style: { color: "hsl(0,0%,50%)" } }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            required: true,
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(CheckCircle, { className: "w-9 h-9 text-white" })
                }
              ),
              /* @__PURE__ */ jsx("h3", { className: "text-xl sm:text-2xl font-black text-white mb-2", children: "Заявка отправлена!" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed mb-5", style: { color: "hsl(0,0%,80%)" }, children: "Для быстрой обработки вашего заказа, пожалуйста, позвоните нам:" }),
              /* @__PURE__ */ jsxs(
                "a",
                {
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs mt-4", style: { color: "hsl(0,0%,55%)" }, children: "Или дождитесь звонка менеджера — мы свяжемся в ближайшее время." })
            ]
          }
        )
      }
  ...
  return /* @__PURE__ */ jsx("section", { id: "pricelist", className: "py-16 sm:py-24 px-3 sm:px-4", children: /* @__PURE__ */ jsxs("div", { className: "container max-w-4xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("p", { className: "text-base sm:text-lg font-bold text-white", children: "🎉 Скидка 20% на первый заказ от 3 000 ₽!" }),
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-amber-200", children: "Извините, в связи с высокой загруженностью минимальный заказ — 500 ₽." })
      }
    ),
    /* @__PURE__ */ jsx(
      "p",
...
const ImageSlider = ({
  ...
  const onTouchEnd = () => {
    ...
    const width = ((_a = containerRef.current) == null ? void 0 : _a.offsetWidth) || 1;
    const dx = dragX;
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        hasMultiple && showDots && /* @__PURE__ */ jsx("div", { className: "absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5 pointer-events-none", children: images.map((_, i) => /* @__PURE__ */ jsx(
          "span",
          {
  ...
  return /* @__PURE__ */ jsx(Dialog, { open: !!project, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsx(DialogContent, { className: "max-w-[96vw] sm:max-w-5xl w-full p-0 border-0 bg-transparent shadow-none [&>button]:hidden", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        "aria-label": "Закрыть",
        children: /* @__PURE__ */ jsx(X, { className: "w-4 h-4 sm:w-5 sm:h-5" })
      }
    ),
    /* @__PURE__ */ jsxs(
      "div",
          ...
          hasMultiple && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(ChevronLeft, { className: "w-3.5 h-3.5 sm:w-5 sm:h-5" })
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(ChevronRight, { className: "w-3.5 h-3.5 sm:w-5 sm:h-5" })
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "absolute bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-black/50 sm:bg-black/60 backdrop-blur-sm text-white/90 text-[11px] sm:text-xs font-medium", children: [
              index + 1,
              " / ",
...
const ProjectCard = ({
  ...
  "article",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 sm:p-5", children: /* @__PURE__ */ jsx("h3", { className: "text-base sm:text-lg font-semibold text-foreground", children: project.title }) })
    ]
  }
);
const ProjectsSection = () => {
  ...
  const scrollToCard = (idx) => {
    ...
    (_a = cards[idx]) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth", inline: "center", block: "nearest" });
  };
  return /* @__PURE__ */ jsxs("section", { id: "projects", className: "py-12 sm:py-16 md:py-24 px-3 sm:px-4 scroll-mt-24", children: [
    /* @__PURE__ */ jsxs("div", { className: "container max-w-6xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center justify-center gap-3 sm:hidden", children: [
          /* @__PURE__ */ jsx("div", { className: "flex gap-1.5", children: projects.map((_, i) => /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
...
const FormatStat = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "text-[10px] sm:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em] opacity-90", children: label }),
        /* @__PURE__ */ jsx("span", { className: "mt-1 text-base sm:text-xl md:text-2xl font-bold tracking-tight tabular-nums text-foreground", children: Math.round(value).toLocaleString("ru-RU") })
      ]
    }
  );
};
const ProductionLoadWidget = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "production-load", className: "px-3 sm:px-4 py-12 sm:py-20", children: /* @__PURE__ */ jsxs(
    "div",
    {
      ref,
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-24 -left-24 h-64 w-64 rounded-full bg-sky-500/20 blur-3xl" }),
        /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-24 -right-24 h-64 w-64 rounded-full bg-fuchsia-500/20 blur-3xl" }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[auto,1fr] gap-8 sm:gap-10 md:gap-16 p-5 sm:p-8 md:p-12 items-center relative", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative mx-auto w-[150px] h-[150px] sm:w-[180px] sm:h-[180px] md:w-[200px] md:h-[200px]", children: [
            /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 200 200", className: "w-full h-full -rotate-90 overflow-visible", children: [
              /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "loadGrad", x1: "0", y1: "0", x2: "1", y2: "1", children: [
                /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: lightColor }),
                /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: mainColor })
              ] }) }),
              /* @__PURE__ */ jsx(
                "circle",
                {
              ...
              /* @__PURE__ */ jsxs(
                "span",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-base sm:text-xl align-top", children: "%" })
                  ]
                }
              ),
              /* @__PURE__ */ jsx("span", { className: "mt-1 text-[9px] sm:text-[11px] uppercase tracking-[0.2em] text-muted-foreground", children: "загрузка" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 sm:space-y-8 text-center md:text-left min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-[11px] uppercase tracking-[0.18em] sm:tracking-[0.24em] text-muted-foreground", children: "Текущая загрузка производства" }),
              /* @__PURE__ */ jsx("h2", { className: "mt-3 text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-balance bg-gradient-to-r from-foreground via-sky-200 to-violet-200 bg-clip-text text-transparent", children: "Работаем в штатном режиме и принимаем заказы" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "h-px w-full bg-gradient-to-r from-sky-500/50 via-violet-500/40 to-transparent" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-muted-foreground", children: "Отпечатано за сегодня, листов" }),
              /* @__PURE__ */ jsx("div", { className: "mt-4 grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-5 gap-2 sm:gap-3", children: FORMATS.map((f) => /* @__PURE__ */ jsx(
                FormatStat,
                {
                  label: f.label,
            ...
            /* @__PURE__ */ jsxs("div", { className: "inline-flex items-start sm:items-center gap-2 sm:gap-3 max-w-full rounded-2xl sm:rounded-full border border-emerald-400/40 bg-gradient-to-r from-emerald-500/15 to-teal-400/10 px-3 sm:px-4 py-2 text-left", children: [
              /* @__PURE__ */ jsxs("span", { className: "relative mt-1.5 sm:mt-0 flex h-2 w-2 shrink-0", children: [
                /* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-70" }),
                /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-2 w-2 rounded-full bg-emerald-500" })
              ] }),
              /* @__PURE__ */ jsx("span", { className: "text-xs sm:text-sm text-muted-foreground", children: slot === "before" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                "Сейчас нерабочее время —",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "принимаем заказы с 10 утра" })
              ] }) : slot === "after" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                "Рабочий день завершён —",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "принимаем заказы на завтра" })
              ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                "Ближайшее окно для старта печати:",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground tabular-nums", children: slot })
              ] }) })
            ] })
          ] })
        ] })
...
const Index = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-black overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx(ProductionLoadWidget, {}),
