  ...
  return (
    <div className="fixed bottom-20 sm:bottom-5 left-3 sm:left-5 z-[90] flex items-center group font-sans animate-fade-in">
      <a
        ...
        className="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-full bg-[hsl(0,0%,8%)] border border-emerald-400/40 text-white text-xs font-bold shadow-[0_0_15px_rgba(16,185,129,0.35)] hover:shadow-[0_0_25px_rgba(16,185,129,0.55)] hover:scale-110 transition-all duration-500"
      >
        <span
          className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-emerald-500/70 to-emerald-400/30 transition-[height] duration-[1200ms] ease-out"
          style={{ height: `${load}%` }}
        />
        <span className="relative tabular-nums">{load}%</span>
      </a>
      ...
      <span className="absolute left-full ml-3 bg-white/95 backdrop-blur text-slate-700 text-xs font-semibold py-2 px-3.5 rounded-xl shadow-lg transition-all duration-500 pointer-events-none whitespace-nowrap border border-slate-100 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0">
        Загруженность · работаем и принимаем заказы
