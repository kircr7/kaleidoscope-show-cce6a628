...
// A0, A1, A2 → 50 шт; A3 → 100 шт; A4 → 300 шт. Ниже порога цена ×2.
const WHOLESALE_THRESHOLDS: Record<string, number> = {
  A0: 50, A1: 50, A2: 50, A3: 100, A4: 300,
};
              ...
              <div className="relative p-5 sm:p-8 md:p-12 flex flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10 mt-10 space-y-4 hidden lg:block">
                  {[
                   ...
                   <div key={i} className="flex items-start gap-4 p-3 -mx-3 rounded-2xl cursor-default">
                      <div
                              ...
                              <div className="flex items-center justify-between gap-2 mt-1.5 flex-wrap">
                                ...
                                <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0 ml-auto">
                                  <div className="flex items-center rounded-lg" style={{ border: '1px solid hsl(240,9%,17%)' }}>
                                    ...
                                    >
                                      <Plus className="w-3 h-3 transition-all duration-150 text-[hsl(0,0%,60%)] group-hover/plus:text-[hsl(140,100%,55%)] group-hover/plus:[filter:drop-shadow(0_0_3px_hsl(140_100%_50%/0.9))] group-active/plus:text-[hsl(140,100%,48%)]" />
                                    </button>
                                  </div>
