...
// Опт = базовая цена. Порог: А0–А2 — от 10 шт, А3 — от 60 шт, А4 — от 100 шт.
const bwPrices = [
  { format: "A4", size: "210×297 мм", threshold: 100, retail: "10 ₽", wholesale: "5 ₽" },
  { format: "A3", size: "297×420 мм", threshold: 60, retail: "28 ₽", wholesale: "14 ₽" },
  { format: "A2", size: "420×594 мм", threshold: 10, retail: "60 ₽", wholesale: "30 ₽" },
  { format: "A1", size: "594×841 мм", threshold: 10, retail: "100 ₽", wholesale: "50 ₽" },
  { format: "A0", size: "841×1189 мм", threshold: 10, retail: "200 ₽", wholesale: "100 ₽" },
];

const colorPrices = [
  { format: "A4", size: "210×297 мм", threshold: 100, retail: "20 ₽", wholesale: "10 ₽" },
  { format: "A3", size: "297×420 мм", threshold: 60, retail: "48 ₽", wholesale: "24 ₽" },
  { format: "A2", size: "420×594 мм", threshold: 10, retail: "80 ₽", wholesale: "40 ₽" },
  { format: "A1", size: "594×841 мм", threshold: 10, retail: "140 ₽", wholesale: "70 ₽" },
  { format: "A0", size: "841×1189 мм", threshold: 10, retail: "220 ₽", wholesale: "110 ₽" },
];
