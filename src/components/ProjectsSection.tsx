...
const projects: Project[] = [
  {
    ...
    alts: [
      ...
      "Развернутый комплект проектных листов А1",
      "Титульный лист проектного тома А2 крупным планом",
      "Архитектурное решение на проектном листе А2",
      "Свернутые в рулон проектные чертежи А1, А2 и А3 после плоттера",
    ],
  ...
  },
  {
    ...
    alts: [
      "Черно-белый рабочий чертеж А0 на столе",
      "Разворот тома рабочей документации с узлами А1, А2 и А3",
      "Стопка рабочих чертежей А1, сложенных по ГОСТ",
  ...
  },
  {
    ...
    alts: [
      ...
      "Сборка актов скрытых работ в единый исполнительный том",
      "Исполнительный том с жёсткой обложкой А3",
      "Исполнительная схема с подписями и печатью А1",
      "Журнал производства работ в общем исполнительном комплекте",
      "Прошитый комплект исполнительных листов А3 для сдачи",
    ],
  ...
  },
  {
    ...
    alts: [
      ...
      "Схема электроснабжения на листе А1",
      "Рулон свежих чертежей А1 и А2 рядом с плоттером",
