...
const projects: Project[] = [
  {
    ...
    alts: [
      "Сшитый том проектной документации А3 после печати проектов",
      "Фальцовка широкоформатного чертежа А1 для проектной документации",
      "Стопка сложенных листов генплана А1 и А2 на рабочем столе",
      "Развернутый комплект проектных листов формата А1 для печати проектов",
      "Титульный лист тома проектной документации А2 крупным планом",
      "Архитектурное решение на листе формата А2 для проектной документации",
      "Свернутые в рулон проектные чертежи форматов А1, А2, А3 после плоттера",
    ],
  ...
  },
  {
    ...
    alts: [
      "Черно-белый рабочий чертеж формата А0 на столе для печати рабочей документации",
      "Разворот тома рабочей документации с узлами форматов А1, А2, А3",
      "Стопка рабочих чертежей формата А1, сложенных по ГОСТ",
      "Проверка масштаба на распечатанном рабочем листе А1",
      "Комплект рабочей документации А1 и А2, готовый к передаче",
    ],
  ...
  },
  {
    ...
    alts: [
      "Комплект исполнительной документации для сдачи заказчику после печати",
      "Сборка актов скрытых работ в единый том исполнительной документации",
      "Том исполнительной документации с жёсткой обложкой формата А3",
      "Исполнительная схема с подписями и печатью формата А1",
      "Журнал производства работ в общем комплекте исполнительной документации",
      "Прошитый комплект исполнительных листов формата А3 для сдачи",
    ],
  ...
  },
  {
    ...
    alts: [
      "Вывод цветного машиностроительного чертежа А1 из плоттера",
      "Черно-белый архитектурный план А0 на столе",
      "Цветной генплан участка А1 после широкоформатной печати",
      "Детальный узел на инженерном чертеже А2 крупным планом",
      "Схема электроснабжения на листе формата А1",
      "Рулон свежих чертежей форматов А1 и А2 рядом с плоттером",
      "Разрез здания на широкоформатном листе А0",
    ],
