...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="relative py-16 sm:py-24 font-sans overflow-hidden">
      {/* Background image */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-amber-400 text-xs font-black uppercase tracking-widest mb-6">
