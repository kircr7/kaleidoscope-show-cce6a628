...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden relative">
      <SEO
        title="Печать чертежей А4–А0 в Москве | Проектная документация"
        ...
        jsonLd={{
          ...
          description:
            "Срочная инженерная печать чертежей и проектной документации форматов А4–А0. Фальцовка и переплёт по ГОСТ.",
          priceRange: "₽₽",
