...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden relative">
      <SEO
        title="Печать чертежей и проектов | Распечатать проектную и рабочую документацию А4, А3, А2, А1, А0"
        description="Срочная печать исполнительной и проектной документации. Цветная и чб печать А4, А3, А2, А1, А0. Фальцовка, брошюровка, работа с юрлицами."
        keywords="печать чертежей, печать проектов, распечатать проектную документацию, распечатать рабочую документацию, печать исполнительной документации, печать А4, печать А3, печать А2, печать А1, печать А0, цветная печать чертежей, чб печать чертежей, фальцовка, брошюровка"
        canonicalPath="/"
        jsonLd={{
      ...
      <section className="pt-16 md:pt-24 px-3 sm:px-4">
        <div className="container max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            Срочно распечатать чертежи форматов А4, А3, А2, А1, А0 (цвет/чб) с фальцовкой по ГОСТ
          </p>
        </div>
        <CarouselSection />
      </section>
